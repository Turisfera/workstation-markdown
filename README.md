...
<!-- Student Outcomes (completo sin Ariadna) -->
<h1><strong>Student Outcomes</strong></h1>

<table border="1">
  <thead>
    <tr>
      <th style="width:100px">Criterio específico</th>
      <th style="width:250px" align="center">Acciones Realizadas</th>
      <th style="width:250px" align="center">Conclusiones</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      ...
      <td>
        <strong>- Marcia Melgarejo</strong><br>
        <strong>TB1:</strong> Expliqué los hallazgos del needfinding y el recorrido del usuario de manera clara, apoyándome en wireframes y prototipos interactivos.<br>
        <strong>TP:</strong> Desarrollé la sección de Experience Manager y la página de layout por defecto.<br>
        <strong>TB2:</strong> Expliqué al equipo el modelado de entidades y su relación con la base de datos.<br>
        <strong>TF:</strong> Presenté el funcionamiento técnico del sistema en la demo final, enfocándome en cómo el diseño del layout y la experiencia de usuario contribuyen al objetivo del proyecto. Adapté el discurso para audiencias técnicas y no técnicas.<br>
        <br><strong>- María Hernández</strong><br>
        <strong>TB1:</strong> Realicé una entrevista y colaboré con wireframes y mockups.<br>
        <strong>TP:</strong> Desarrollé la vista de Reservas para la sección de Agencias.<br>
        <strong>TB2:</strong> Presenté el flujo de autenticación y login.<br>
        <strong>TF:</strong> Expuse las funcionalidades de la vista de agencias y cómo estas aportan a la eficiencia del sistema. Expliqué detalles de seguridad y validación adaptando el lenguaje a la audiencia evaluadora.<br>
        <br><strong>- Britney Qqueso</strong><br>
        <strong>TB1:</strong> Colaboré en las Style Guidelines, arquitectura de información, SEO y entrevistas.<br>
        <strong>TP:</strong> Desarrollé la sección de Consultas y corregí el diagrama C4 y el README.<br>
        <strong>TB2:</strong> Conduje entrevistas de validación y documenté el Sprint 3.<br>
        <strong>TF:</strong> Presenté los resultados de validaciones finales y el impacto de las mejoras propuestas. Me enfoqué en la experiencia de usuario y la sostenibilidad del producto ante el público.<br>
        <br><strong>- Jorge Guevara</strong><br>
        <strong>TB1:</strong> Expliqué la metodología al equipo y realicé una entrevista a agencias.<br>
        <strong>TP:</strong> Desarrollé la vista principal para turistas y el diseño responsive de la landing.<br>
        <strong>TB2:</strong> Expliqué endpoints de paquetes turísticos y destinos.<br>
        <strong>TF:</strong> Presenté la integración entre frontend y backend en los módulos turísticos, explicando los beneficios de la arquitectura modular ante evaluadores con distintos niveles técnicos.<br>
        <br><strong>- Rodrigo Alaya</strong><br>
        <strong>TB1:</strong> Presenté la configuración del entorno, herramientas y estructura GitFlow.<br>
        <strong>TP:</strong> Desarrollé la sección de perfil de agencia.<br>
        <strong>TB2:</strong> Expliqué el despliegue con Docker y docker-compose.<br>
        <strong>TF:</strong> Expuse la estrategia de despliegue final del sistema y su documentación, incluyendo prácticas de mantenimiento y escalabilidad, dirigiéndome a audiencias técnicas.<br>
        <br><strong>- Raúl Medina</strong><br>
        <strong>TB1:</strong> Expliqué la lógica de los endpoints iniciales y su integración con la base de datos.<br>
        <strong>TP:</strong> Desarrollé la sección de reservas para turistas.<br>
        <strong>TB2:</strong> Expuse los casos de uso de inscripción y lógica de itinerarios.<br>
        <strong>TF:</strong> Expuse en la presentación final los avances del Sprint 4, enfocándome en conclusiones y recomendaciones, y adaptando el mensaje para distintos tipos de audiencia.
      </td>
      <td>
        <strong>TB1:</strong> Cada integrante cumplió con sus tareas, manteniendo comunicación constante que fortaleció la confianza del equipo.<br>
        <strong>TP:</strong> Todos demostraron responsabilidad y compromiso, lo que favoreció la colaboración y éxito del proyecto.<br>
        <strong>TB2:</strong> El equipo expuso sus aportes con claridad ante diferentes audiencias, consolidando la comunicación oral como herramienta clave.<br>
        <strong>TF:</strong> Cada integrante comunicó oralmente sus avances ante el jurado de forma estructurada, adaptando el contenido al perfil de la audiencia y permitiendo evidenciar el valor del trabajo realizado.
      </td>
    </tr>
    <tr>
      ...
      <td>
        <strong>- Marcia Melgarejo</strong><br>
        <strong>TB1:</strong> Documenté todo el proceso de diseño de TripMatch, incluyendo needfinding, wireframes y prototipos.<br>
        <strong>TP:</strong> Documenté Sprint Planning 2 con tareas y entregables definidos.<br>
        <strong>TB2:</strong> Documenté el modelado de entidades del backend.<br>
        <strong>TF:</strong> Redacté la sección de conclusiones del informe final, detallando el impacto técnico y social del sistema.<br>
        <br><strong>- María Hernández</strong><br>
        <strong>TB1:</strong> Hice el diagrama de base de datos, antecedentes, problemática y segmentos.<br>
        <strong>TP:</strong> Documenté la asignación de roles del Sprint 2.<br>
        <strong>TB2:</strong> Redacté flujos de autenticación con diagramas.<br>
        <strong>TF:</strong> Escribí el resumen ejecutivo del sistema final y los beneficios técnicos que ofrece TripMatch para agencias y usuarios.<br>
        <br><strong>- Britney Qqueso</strong><br>
        <strong>TB1:</strong> Coordiné lineamientos de estilo y landing page.<br>
        <strong>TP:</strong> Documenté evidencias de desarrollo y ejecución del Sprint 2.<br>
        <strong>TB2:</strong> Redacté observaciones de entrevistas y Sprint 3.<br>
        <strong>TF:</strong> Redacté el informe final de validaciones del sistema y conclusiones técnicas obtenidas en la etapa final.<br>
        <br><strong>- Jorge Guevara</strong><br>
        <strong>TB1:</strong> Ayudé con los lineamientos y el capítulo 3.<br>
        <strong>TP:</strong> Documenté el Sprint Backlog 2 y dependencias.<br>
        <strong>TB2:</strong> Escribí la documentación técnica de endpoints y DTOs.<br>
        <strong>TF:</strong> Redacté las recomendaciones para el mantenimiento y evolución del sistema desde la perspectiva del backend.<br>
        <br><strong>- Rodrigo Alaya</strong><br>
        <strong>TB1:</strong> Documenté configuración de entorno, despliegue y herramientas.<br>
        <strong>TP:</strong> Documenté los servicios del Sprint 2.<br>
        <strong>TB2:</strong> Redacté la guía de entorno Docker.<br>
        <strong>TF:</strong> Elaboré el anexo técnico con estructura del backend, rutas REST y estrategias de escalado.<br>
        <br><strong>- Raúl Medina</strong><br>
        <strong>TB1:</strong> Documenté entrevistas y beneficios de la landing. Ayudé en Capítulo V.<br>
        <strong>TP:</strong> Documenté los insights de colaboración del equipo.<br>
        <strong>TB2:</strong> Escribí los casos de uso y lógica del dominio de itinerarios.<br>
        <strong>TF:</strong> Redacté la sección de arquitectura y conclusiones del backend, con diagramas de secuencia y flujos de datos.
      </td>
      <td>
        <strong>TB1:</strong> Todos redactaron con claridad técnica y orden, facilitando la comprensión del proyecto.<br>
        <strong>TP:</strong> La comunicación escrita favoreció la organización y trazabilidad del Sprint.<br>
        <strong>TB2:</strong> La documentación permitió una integración efectiva de módulos y conocimientos compartidos.<br>
        <strong>TF:</strong> La redacción final del informe fue clara, técnica y bien estructurada. Permitió a lectores técnicos y no técnicos entender el sistema, facilitando su evaluación y escalabilidad.
      </td>
    </tr>
  </tbody>
</table>
