...
**URL BACKEND DESPLEGADO:**: https://back-9syy.onrender.com/swagger/index.html
...
![Flujo de Viajes por Turismo Interno](./assets/img/Flujo-de-Viajes-por-Turismo-Interno.png)
...
El Impact Mapping es una metodología visual y ágil que permite a las organizaciones enfocar el desarrollo de productos y servicios en función de sus metas estratégicas. Esta técnica facilita la identificación de una relación directa entre los objetivos del negocio, las acciones esperadas de los usuarios clave y las soluciones o funcionalidades que deben implementarse para lograr dichos objetivos.![Impact Mapping](./assets/img/Impact-map-Turisfera.png)
...
![Context Diagram TripMatch](./assets/img/Context-Diagram.png)

### 4.6.2. Software Architecture Container Diagrams

El Diagrama de Contenedores descompone TripMatch en sus unidades ejecutables principales. Este nivel muestra la separación entre la interfaz pública, la SPA (Single Page Application), la API del backend y la base de datos. También se presentan las relaciones entre estos contenedores y los servicios externos utilizados por el sistema.

![Component Diagram TripMatch](./assets/img/Container-Diagram.png)

### 4.6.3. Software Architecture Components Diagrams

El Diagrama de Componentes profundiza en el contenedor del backend (API Application), detallando los Bounded Contexts y las capas internas que implementan la lógica de negocio. Cada contexto sigue una arquitectura en capas basada en DDD (Domain-Driven Design), permitiendo una alta cohesión, separación de responsabilidades y escalabilidad.

![Container Diagram TripMatch](./assets/img/Components-Diagram.png)

*User Bounded Context Component Diagram*
![Bounded Context Component Diagram](./assets/img/component-diagram-users.png)

*Experience Bounded Context Component Diagram*
![Bounded Context Component Diagram](./assets/img/component-diagram-experience.png)

*Booking Bounded Context Component Diagram*
![Bounded Context Component Diagram](./assets/img/component-diagram-bookings.png)

*IAM Bounded Context Component Diagram*
![Bounded Context Component Diagram](./assets/img/component-diagram-iam.png)

*Favorite Bounded Context Component Diagram*
![Bounded Context Component Diagram](./assets/img/component-diagram-favorites.png)

*Inquiry Bounded Context Component Diagram*
![Bounded Context Component Diagram](./assets/img/component-diagram-inquiry.png)

*Review Bounded Context Component Diagram*
![Bounded Context Component Diagram](./assets/img/component-diagram-reviews.png)
...
El Sprint Planning 2 es la reunión inicial de la iteración donde el equipo define la meta (Sprint Goal), revisa el Sprint anterior y selecciona los User Stories que abordará en este Sprint.
...
Durante el Sprint 2 se avanzó en la estructuración base del sistema post-login, así como en mejoras visuales responsivas y rutas diferenciadas.
...
| user/turisfera-web    | feature/fixes-doc        | x1e2f3g       | fix: readme y diagrama actualizados      | Correcciones ortográficas y de estructura del documento base                                                          | 2025-05-09       |
...
- Secciones iniciales de reservas, consultas, perfil e itinerarios
...
Los servicios están documentados en Postman y se conectarán con el backend en el Sprint 3.

#### 5.2.2.7 Software Deployment Evidence for Sprint Review

Los avances del Sprint 2 se integraron a la rama principal `main` y se configuró el despliegue continuo en **Firebase Hosting**, reemplazando el uso anterior de GitHub Pages.

- Branch principal: `main`
- Plataforma de despliegue: `Firebase`
- Acción automatizada: `firebase deploy`

**URL en producción:**  
https://trip-match-2025.web.app/manageExperience
...
<table> 
  ...
  <tr> 
    ...
    <td>Conectar el frontend con el backend para mostrar itinerarios guardados. 
    </td> 
    <td>2 hr</td> 
    <td>María Hernández</td> 
    <td>Done</td> 
...
Evidencia 4: 
Evidencia de implementacion de busqueda por filtros para las experiencias
![Evidencia 4](./assets/img/Experience-busqueda.png)
![Evidencia 5](./assets/img/experience-search-result.png)

Evidencia 5: 
Evidencia de implementacion de reservas
![Evidencia 6](./assets/img/reservations.png)
...
| 2 | - **Nombre:** Joaquin Alejandro <br> - **Edad:** 20 años <br> - **Distrito:** Jesus Maria <br> - **Link:** [Entrevista 1: Joaquin Gudiel](https://upcedupe-my.sharepoint.com/personal/u20221d382_upc_edu_pe/_layouts/15/stream.aspx?id=%2Fpersonal%2Fu20221d382%5Fupc%5Fedu%5Fpe%2FDocuments%2FVID%5F20250619%5F233803%2Emp4&referrer=StreamWebApp%2EWeb&referrerScenario=AddressBarCopied%2Eview%2Ec0a66987%2D8b57%2D438b%2D922f%2D5c0b4db84e83&isDarkMode=false) | Joaquín considera que la landing page es fácil de entender y destaca que sus opciones son muy útiles, ya que le facilitan el trabajo. También valora positivamente que la plataforma establezca conexión con agencias pequeñas, lo cual le parece una ventaja. Sin embargo, menciona que la forma en que se apliquen los anuncios en la landing page puede influir en el tiempo que permanece en ella.| ![Entrevista 3](assets/img/entrevista-validacion-turista-2.png) |
| 3 | - **Nombre:** Darlin Castillo <br> - **Edad:** 23 años <br> - **Distrito:** Surco <br> - **Link:** [Entrevista 3: Darlin Castillo](https://upcedupe-my.sharepoint.com/:v:/g/personal/u20211g671_upc_edu_pe/EeBfoQ4eIT1Mj1esUkQjS4YBJquJF53_foGSF_zNHw9k-g?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJPbmVEcml2ZUZvckJ1c2luZXNzIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXciLCJyZWZlcnJhbFZpZXciOiJNeUZpbGVzTGlua0NvcHkifX0&e=mRzVwo) | Darlin considera que la página de destino es sumamente fácil de comprender, destacando su diseño intuitivo y la claridad de su presentación. Resalta que las opciones y funcionalidades que ofrece la plataforma son excepcionalmente útiles, ya que simplifican y agilizan significativamente su trabajo. Adicionalmente, valora de forma muy positiva que la plataforma tenga la capacidad de establecer conexión con agencias pequeñas, lo cual percibe como una ventaja competitiva considerable y un beneficio importante para su operación.| ![Entrevista 3](assets/img/entrevista-validacion-turista-3.png) |
...
| 3 | - **Nombre:** Abigail Rodriguez <br> - **Edad:** 21 años <br> - **Distrito:** Santiago de Surco <br> - **Link:** [Entrevista 2: Abigail Rodriguez](https://upcedupe-my.sharepoint.com/:v:/g/personal/u202210938_upc_edu_pe/EfzzEOikkFtMinx8Wkjdp1EBTC3PtUBqpE9WyVsSf5e1tg?e=Bd6v5J&nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D) | Abigail Rodríguez consideró que el diseño del prototipo es atractivo e intuitivo, aunque recomienda añadir guías para nuevos usuarios. Destacó la utilidad de las funciones para facilitar la búsqueda y reserva de experiencias turísticas. Sobre la Landing Page, sugirió incluir más imágenes, testimonios y una sección de preguntas frecuentes. Opinó que la publicidad no afectaría si es moderada y relevante. Finalmente, propuso agregar funciones como guardar experiencias, recibir recomendaciones y mejorar el soporte técnico, priorizando siempre las funciones más útiles para los usuarios. | ![Entrevista 3](./assets/img/Image-Interview-AbigailRodriguez.png) |
...
## Conclusiones: 
Gracias al enfoque iterativo basado en Lean UX y metodologías ágiles, el equipo logró avanzar progresivamente en la definición, diseño, desarrollo y validación de la plataforma TripMatch, una solución que conecta a viajeros con agencias de turismo locales mediante experiencias auténticas y personalizadas.

Desde la etapa inicial, se realizaron entrevistas de needfinding, construcción de User Personas, Empathy Maps y escenarios As-Is/To-Be que permitieron entender profundamente a los segmentos objetivo. A partir de esta investigación, se formularon hipótesis de valor y se definió un Product Backlog robusto que guió el desarrollo de las funcionalidades clave.

Durante los sprints, se logró desarrollar desde la Landing Page y los módulos base de autenticación hasta la integración completa entre frontend y backend, permitiendo funcionalidades como la gestión de reservas, favoritos, itinerarios y perfil de usuarios y agencias. Se aplicaron principios de diseño accesible, uso de componentes reutilizables y una arquitectura centrada en el dominio.

El equipo demostró un alto nivel de colaboración y responsabilidad, documentando cada etapa con claridad y asegurando la trazabilidad de los entregables. Además, se implementaron mecanismos de despliegue continuo, documentación Swagger y validaciones con usuarios reales, lo que fortaleció la calidad técnica y funcional del producto.
...
**Aprovechar más las herramientas colaborativas:** Herramientas como Trello, GitHub Projects y Notion fueron útiles, pero su uso podría haber sido más sistemático. Se sugiere asignar responsables de seguimiento por herramienta para asegurar que los avances estén reflejados y alineados con el progreso real del equipo.
